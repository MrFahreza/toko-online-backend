-- CreateEnum
CREATE TYPE "Role" AS ENUM ('PEMBELI', 'CS1', 'CS2');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('MENUNGGU_UPLOAD_BUKTI', 'MENUNGGU_VERIFIKASI_CS1', 'MENUNGGU_DIPROSES_CS2', 'DIBATALKAN', 'SEDANG_DIPROSES', 'DIKIRIM', 'SELESAI');
...
CREATE TABLE "Order" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "status" "OrderStatus" NOT NULL DEFAULT 'MENUNGGU_UPLOAD_BUKTI',
